...
// only accessible in Java 1.8 and 1.7
...
public class HttpRequestSender {
    ...
    public static HttpRequestSender getSender(){
        return new HttpRequestSender(null,80);
    }
...
//    }
    ...
    public HttpResponse send(URL aUrl, String verb) {
        return send(aUrl, verb, new HashMap<String, String>(), "");
    }
